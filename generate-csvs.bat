...
bin\sample standard.csv pre-assessment.csv --sample-param=assessment --sample-period=pre --sample-offset=2 --filter-irrelevant --subject-weight=30
bin\sample standard.csv post-assessment.csv --sample-param=assessment --sample-period=post --sample-offset=2 --filter-irrelevant --subject-weight=30
bin\sample standard.csv over-assessment.csv --sample-param=assessment --sample-period=during --filter-irrelevant --subject-weight=30
