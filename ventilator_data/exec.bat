...
python time-sample.py standard.csv 10-from-recruitment.csv --sample-start=recruitment --sample-offset=0:02 --sample-freq=0:10 --filter-irrelevant --reformat-time
